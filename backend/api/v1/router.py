...
from backend.api.v1.ambulance import router as ambulance_router
from backend.api.v1.auth import router as auth_router
from backend.api.v1.cases import router as cases_router
from backend.api.v1.dispatcher import router as dispatcher_router
from backend.api.v1.hospital import router as hospital_router
...
from backend.api.v1.triage_ws import router as triage_ws_router
